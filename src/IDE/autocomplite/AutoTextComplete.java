...
//declarations for table
    ...
    public void focusGained(FocusEvent fe) {
        if (fe.getSource() == lst) {
            ...
            try {
                ...
                Logger.getLogger(AutoTextComplete.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
    }
    ...
    private void populateList() throws BadLocationException {
        String txt = "";
        int r = 0, c = 0;
        if (tableParent != null) {
            ...
            txt = txt.substring(i + 1, n + 1);
               ...
               if(pos>0)
               txt =  parent.getText().substring( Utilities.getPreviousWord(parent,pos),pos);
        }
        tempVector.clear();
        int index = lst.getSelectedIndex();
